...
export const projects: Project[] = [
  {
    ...
    description:
      "Aplicacao full-stack que une tecnologia moderna com proposito social. Sistema completo de pedidos personalizado para lanchonete 100% vegana, com ingredientes organicos, precos acessiveis e rastreamento individual de impacto ambiental positivo.",
    category: "digital",
    featured: true,
    images: ["/projects/gabriel-pastel-hero.png"],
    problem:
      "Lanchonetes veganas precisam de sistemas que comuniquem seus valores alem de apenas vender. Plataformas genericas nao contam a historia nem engajam clientes com o proposito ambiental e animal.",
    construction:
    ...
    decisions:
      "Autenticacao propria com NextAuth.js e JWT para controle total. Design system customizado com paleta vegana (vegGreen, vegYellow, vegBrown). Dashboard mostra estatisticas de impacto: animais salvos, recursos economizados. Painel admin completo para gestao de pedidos e ingredientes.",
    result:
      "Sistema completo de pedidos funcionando. Usuarios acompanham seu impacto individual. A pagina Nossa Historia comunica os valores de compaixao, sustentabilidade e sabor de forma imersiva.",
    tools: [
      "Next.js 15",
      "React 19",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "Recicladora que transforma garrafas PET descartadas em filamento para impressao 3D. Hardware, programacao e sustentabilidade em um sistema desenvolvido no TechLab da Fatec Carapicuiba sob orientacao da Prof. Magali Rossi.",
    category: "digital",
    featured: true,
    images: [
      "/projects/mf6.jpg",
    ...
    problem:
      "Bilhoes de garrafas PET sao descartadas anualmente enquanto filamento para impressao 3D e caro e de origem petroquimica. Como transformar lixo plastico em recurso tecnologico acessivel e util?",
    construction:
